...
export const PathButton = (props: Props) => {
  ...
  return (
    <motion.div className={`absolute w-[calc(81.94px*var(--size-ratio))] h-[calc(81.94px*var(--size-ratio))] ${className ?? ''}`} {...rest}>
      ...
      >
        <motion.span
          className={`flex items-center justify-center border-2 rounded-[calc(2px*var(--size-ratio))] border-[#000000] w-[calc(66.91px*var(--size-ratio))] h-[calc(66.91px*var(--size-ratio))] transition-[background] duration-200 ${locked ? 'bg-[#262773]' : passed ? 'bg-[#FFFFFF]' : 'bg-[#EA5616]'}`}
        >
          {locked ? (
            <svg className='w-[calc(50px*var(--size-ratio))] h-[calc(50px*var(--size-ratio))]' viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg className='w-[calc(44px*var(--size-ratio))] h-[calc(38px*var(--size-ratio))]' viewBox="0 0 44 38" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M6.30239 11.9241L0 17.6897L16.3395 38L44 7.07586L37.931 0L16.3395 24.5034L6.30239 11.9241Z" fill="#262773"/>
            </svg>
          ) : (
            <svg className='w-[calc(33px*var(--size-ratio))] h-[calc(41px*var(--size-ratio))]' viewBox="0 0 33 41" fill="none" xmlns="http://www.w3.org/2000/svg">
