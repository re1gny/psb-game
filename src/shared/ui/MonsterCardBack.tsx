  ...
  return (
    ...
    >
      ...
      >
        ...
        <div 
          className="mt-[calc(14px*var(--size-ratio))] flex flex-col relative w-full flex-grow rounded-[calc(8.79px*var(--size-ratio))] border-[calc(1.76px*var(--size-ratio))] border-[#000000] py-[calc(12px*var(--size-ratio))] pl-[calc(24px*var(--size-ratio))] pr-[calc(8px*var(--size-ratio))] bg-[#FFFFFF] overflow-auto"
        >
