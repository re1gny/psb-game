...
export const MONSTER_2: Monster = {
    ...
    backImageWidth: 209,
    backImageHeight: 209,
    details: 'Он обожает устраивать саботаж, когда у тебя есть срочные документы, превращая простую задачу в квест на выживание. Только ты нажимаешь «Печать» — и начинается: бумага зажевывает самый важный лист, только\nчто заправленный картридж оказывается пустым, а драйверы загадочно самоудаляются. Как будто у техники есть личная\nместь против тебя'
};
