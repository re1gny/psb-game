...
export const CHARACTER_1: Character = {
    ...
    pros: [
        'Креатив и тренды — её страсть. Знает каждый наряд на Met Gala и мемы из TikTok',
        'Мечтает быть ивент‑менеджером… а кто не хочет каждый день быть шеф-поваром, детективом и психологом одновременно?'
    ],
...
export const CHARACTER_2: Character = {
    ...
    pros: [
        ...
        'Не понимает мемы про импульсивные покупки. И кто вообще может так спонтанно тратить деньги?',
    ],
    cons: [
...
export const CHARACTER_8: Character = {
    ...
    pros: [
      ...
      'Смотрел все выпуски «Орла\nи решки» и завёл блокнот-путеводитель по миру'
    ],
    cons: [
