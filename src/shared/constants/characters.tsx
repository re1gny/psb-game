...
export const CHARACTER_1: Character = {
    ...
    pros: [
        ...
        '100% внимания к деталям — её день расписан по минутам, а любимое занятие — ставить галочки в списке дел'
    ],
...
export const CHARACTER_2: Character = {
    ...
    pros: [
        'Каждый рубль учтён и не выбьется из формулы Excel',
        'Практична и опытна: виртуозно расставляет задачи закрытыми глазами',
    ],
    cons: [
        'Творческий подход не её сильная сторона — предпочитает проверенные временем решения',
    ],
    backSign: (
...
export const CHARACTER_3: Character = {
    ...
    pros: [
        'Впервые видит картридж вживую',
        'Паникует, если комбинация кнопок «включить-выключить» не срабатывает'
    ],
    backSign: (
...
export const CHARACTER_4: Character = {
    ...
    pros: [
      ...
      'Знает секретный код для сброса настроек принтера',
      'Знает секретный лайфхак: «Если стукнуть по корпусу — заработает»'
    ],
    cons: [
...
export const CHARACTER_5: Character = {
    ...
    pros: [
      'Адепт Figma и Canva — в её арсенале 100 шаблонов презентации для любого проекта',
      'Работает с психологом уже несколько месяцев и знает, как бороться со стрессом и тревогой',
    ],
    cons: [
      'Публичные выступления — её личный ад: она не выносит взгляды аудитории',
    ],
    backSign: (
...
export const CHARACTER_6: Character = {
    ...
    pros: [
      'На собеседовании ждёт, когда рекрутер попросит «продать ручку», ведь у него в запасе уже 10 способов',
      'Играл в КВН в универе — и даже выиграл звание «Лучшего актёра»',
    ],
    cons: [
      'Скептически относится к психологии: считает, что «само пройдёт» и заедает стресс чем‑нибудь сладким',
    ],
    backSign: (
...
export const CHARACTER_7: Character = { 
    ...
    pros: [
      'Гуру нейросетей — написал 100+ промптов и вывел идеальную формулу общения с ChatGPT',
      'В арсенале сотни нейросетей на все случаи жизни',
    ],
    cons: [
      'Слепо доверяет GPT как своему лучшему другу, даже если тот утверждает, что столица Турции — Стамбул'
    ],
    backSign: (
...
export const CHARACTER_8: Character = {
    ...
    pros: [
      'Её гугл-таблицы учитывают все — от времени на дорогу до среднего чека в кафе',
      'Смотрела все выпуски «Орла и решки» и завела блокнот-путеводитель по миру'
    ],
    cons: [
...
export const CHARACTER_9: Character = {
    ...
    pros: [
      'Может поддержать морально в любой ситуации',
      'Ходячий цитатник Брайана Трейси, Кови и Джо Диспензы наизусть. «Каждое утро — шанс начать сначала», «Не ошибается тот, кто ничего не делает» — её Telegram-канал хранилище мотивационных фраз'
    ],
    cons: [
...
export const CHARACTER_10: Character = {
    ...
    pros: [
      'Построил идеальную систему для жизни в Notion с целями, привычками, базой фильмов и даже шаблонами для свиданий',
      'Профессионал по созданию идеальных to-do листов'
    ],
    cons: [
      'Постоянно переделывает шаблон вместо того, чтобы действовать по нему'
    ],
    backSign: (
