  ...
  return (
    <>
      <div className={'relative bg-cover h-full'} style={{ backgroundImage: `url(${bg})` }}>
        <LivesScore className={`absolute top-[calc(20px*var(--size-ratio))] right-[calc(21px*var(--size-ratio))] transition-[filter] duration-200 ${hasBlur ? 'blur pointer-events-none' : ''}`} remainingLives={remainingLives} />
        <div className={`absolute top-0 left-1/2 -translate-x-1/2 max-w-[calc(375px*var(--size-ratio))] max-h-[calc(667px*var(--size-ratio))] w-full h-full transition-[filter] duration-200 ${hasBlur ? 'blur pointer-events-none' : ''}`}>
          <svg className={'absolute left-[calc(120px*var(--size-ratio))] top-[calc(-9.5px*var(--size-ratio))] w-[calc(150px*var(--size-ratio))] h-[calc(583px*var(--size-ratio))]'} viewBox="0 0 150 583" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M27.5 581.5C67.8333 582.333 148.5 560.1 148.5 464.5C144.1 444.5 123 439.833 113 440C76 445.167 1.8 436.1 1 358.5C1 317.7 26.6667 313.5 39.5 316.5C78.1667 321.667 154.1 307.6 148.5 210C142.9 194.8 122.5 183.667 113 180C64.3333 177.5 -15.4 114.1 21 -9.5" stroke="white" className='stroke-[calc(2px*var(--size-ratio))]' />
          </svg>
          <PathButton className={'absolute top-[calc(538px*var(--size-ratio))] left-[calc(81px*var(--size-ratio))]'} locked={false} passed={passedLevels.includes(1)} onClick={() => play(1)} />
          <PathButton className={'absolute top-[calc(394px*var(--size-ratio))] left-[calc(227px*var(--size-ratio))]'} locked={!passedLevels.includes(1)} passed={passedLevels.includes(2)} onClick={() => play(2)} />
          <PathButton className={'absolute top-[calc(282px*var(--size-ratio))] left-[calc(82px*var(--size-ratio))]'} locked={!passedLevels.includes(2)} passed={passedLevels.includes(3)} onClick={() => play(3)} />
          <PathButton className={'absolute top-[calc(138px*var(--size-ratio))] left-[calc(227px*var(--size-ratio))]'} locked={!passedLevels.includes(3)} passed={passedLevels.includes(4)} onClick={() => play(4)} />
        </div>
        <div className={'flex flex-col items-center gap-[calc(15px*var(--size-ratio))] absolute top-[calc(20px*var(--size-ratio))] left-[calc(20px*var(--size-ratio))]'}>
          <button ref={collectionRef} onClick={() => setRulesModalOpened(true)} className={`flex items-center justify-center border-2 border-[#000000] rounded-[calc(10px*var(--size-ratio))] bg-[#EA5616] w-[calc(48px*var(--size-ratio))] h-[calc(48px*var(--size-ratio))] transition-[filter] duration-200 ${hasBlur && step !== 1 ? 'blur pointer-events-none' : 'z-20'}`}>
          ...
          <motion.button
            ...
            onClick={() => setCharactersModalOpened(true)} className={`flex items-center justify-center border-2 border-[#000000] rounded-[calc(10px*var(--size-ratio))] bg-[#EA5616] w-[calc(48px*var(--size-ratio))] h-[calc(48px*var(--size-ratio))] transition-[filter] duration-200 ${hasBlur && step !== 3 ? 'blur pointer-events-none' : 'z-20'}`}>
            <svg className='w-[calc(29px*var(--size-ratio))] h-[calc(32px*var(--size-ratio))]' viewBox="0 0 29 32" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <button onClick={() => setMonstersModalOpened(true)} className={`flex items-center justify-center border-2 border-[#000000] rounded-[calc(10px*var(--size-ratio))] bg-[#EA5616] w-[calc(48px*var(--size-ratio))] h-[calc(48px*var(--size-ratio))] transition-[filter] duration-200 ${hasBlur && step !== 5 ? 'blur pointer-events-none' : 'z-20'}`}>
            <svg className='w-[calc(29px*var(--size-ratio))] h-[calc(32px*var(--size-ratio))]' viewBox="0 0 29 32" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <AnimatePresence>
          {step === 1 && (
            <motion.div
              ...
              className={'flex flex-col items-center absolute top-[calc(238px*var(--size-ratio))] left-[calc(20px*var(--size-ratio))] w-[calc(100%-(40px*var(--size-ratio)))]'}
            >
              <motion.svg exit={{ opacity: 0 }} className={'absolute -translate-y-full left-[calc(48px*var(--size-ratio))] top-[calc(9px*var(--size-ratio))] w-[calc(129px*var(--size-ratio))] h-[calc(210px*var(--size-ratio))]'} viewBox="0 0 129 210" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className={'absolute top-0 left-1/2 -translate-x-1/2 max-w-[calc(375px*var(--size-ratio))] max-h-[calc(667px*var(--size-ratio))] w-full h-full'}>
                <motion.div className={'flex flex-col items-center w-full'} exit={{ opacity: 0, scale: 0.8 }}>
                  <motion.div className={'relative bg-[#FFFFFF] border-2 border-[#000000] rounded-[calc(7.41px*var(--size-ratio))] p-[calc(20px*var(--size-ratio))] px-[calc(40px*var(--size-ratio))] w-full z-10'}>
        ...
        <AnimatePresence>
          {step === 3 && (
            ...
            >
              <motion.svg exit={{ opacity: 0 }} className={'absolute -translate-y-full left-[calc(48px*var(--size-ratio))] top-[calc(9px*var(--size-ratio))] w-[calc(125px*var(--size-ratio))] h-[calc(139px*var(--size-ratio))]'} viewBox="0 0 125 139" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className={'absolute top-0 left-1/2 -translate-x-1/2 max-w-[calc(375px*var(--size-ratio))] max-h-[calc(667px*var(--size-ratio))] w-full h-full'}>
                <motion.div className={'flex flex-col items-center w-full'} exit={{ opacity: 0, scale: 0.8 }}>
                  <motion.div className={'relative bg-[#FFFFFF] border-2 border-[#000000] rounded-[calc(7.41px*var(--size-ratio))] py-[calc(20px*var(--size-ratio))] px-[calc(40px*var(--size-ratio))] w-full z-10'}>
                    <p className={'whitespace-pre-line font-gilroy font-light text-[calc(16px*var(--size-ratio))] leading-[105%] tracking-[0.01em] text-[#000000] text-center'}>
        ...
        <AnimatePresence>
          {step === 5 && (
            <motion.div
              ...
              className={'flex flex-col items-center absolute top-[calc(229px*var(--size-ratio))] left-[calc(20px*var(--size-ratio))] w-[calc(100%-(40px*var(--size-ratio)))]'}
            >
              <motion.svg exit={{ opacity: 0 }} className={'absolute -translate-y-full left-[calc(51px*var(--size-ratio))] top-[calc(-3.5px*var(--size-ratio))] w-[calc(121px*var(--size-ratio))] h-[calc(66px*var(--size-ratio))]'} viewBox="0 0 121 66" fill="none" xmlns="http://www.w3.org/2000/svg">
